...
This is a [Graphcast] Radio focused on sending automated messages about particular subgraphs on a P2P network. The available message types are Public Proof of Indexing (PoI) messages from an indexer, or a version intent message from a subgraph owner.
